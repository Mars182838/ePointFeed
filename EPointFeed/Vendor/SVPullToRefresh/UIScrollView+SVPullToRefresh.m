...
- (id)initWithFrame:(CGRect)frame {
    if(self = [super initWithFrame:frame]) {
        ...
        self.textColor = [UIColor colorWithRed:204/255.0f green:204/255.0f blue:204/255.0f alpha:1];
...
- (void)layoutSubviews {
    ...
    if(hasCustomView) {
        ...
        CGSize titleSize = [self.titleLabel.text boundingRectWithSize:CGSizeMake(labelMaxWidth,self.titleLabel.font.lineHeight) options:NSStringDrawingTruncatesLastVisibleLine attributes:nil context:nil].size;
        
        CGSize subtitleSize = [self.subtitleLabel.text boundingRectWithSize:CGSizeMake(labelMaxWidth,self.subtitleLabel.font.lineHeight) options:NSStringDrawingTruncatesLastVisibleLine attributes:nil context:nil].size;
        ...
        if(subtitleSize.height > 0){
            ...
            CGFloat titleY = minY;
            self.titleLabel.frame = CGRectIntegral(CGRectMake(labelX, titleY, titleSize.width + 50, titleSize.height));
...
- (SVPullToRefreshArrow *)arrow {
    if(!_arrow) {
        ...
        _arrow = [[SVPullToRefreshArrow alloc] initWithFrame:CGRectMake(0, self.bounds.size.height-54, 15, 15)];
...
- (void)drawRect:(CGRect)rect {
    UIImage* image = [UIImage imageNamed:@"ark_icon_pulldown"];
